      ...
      <div className="flex flex-col w-full relative h-screen">
        ...
        <div className="absolute bottom-0 right-0">
          <div className=" rounded-full bg-gray">
              <img src="/asset/img/shape-collection.svg" />
          </div>
        </div>
          ...
          <div className="max-w-5xl items-center justify-between font-mono text-sm lg:flex">
            ...
            <div className="hero min-h-screen">
              <div className="hero-content flex-col lg:flex-row-reverse">
                {/* Hero Text */}
                <div className="text-center lg:text-left backdrop-blur-md bg-base-300/90 p-20 rounded-2xl">
                
                  <h1 className="text-5xl font-bold flex flex-row">
                    <div className="w-12 rounded-full bg-gray mr-3">
